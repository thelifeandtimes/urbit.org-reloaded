...
It then uses the Urbit runtime, Vere, to run on any 'host' operating system. Presently this is done via [Unix binaries](https://docs.urbit.org/get-on-urbit#get-the-urbit-runtime) to support running on both Linux and MacOS, but in the near future there will also be Window's binaries as well.
