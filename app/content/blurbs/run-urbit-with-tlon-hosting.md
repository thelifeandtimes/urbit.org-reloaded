...
If you are looking to get on the network and have Tlon host your urbit ship, rather than [self-hosting it yourself](/overview/running-urbit/run-urbit-os), but don't know anyone already on the network, follow [this link](https://join.tlon.io/0v7.m3p2b.iraia.rsse5.p36j3.ggbk8) to join the Urbit Foundation's public groun on Tlon Messenger. Introduce yourself and someone will gladly show you around.
...
If you are already on Tlon Messenger, you can invite your friends by creating an invite and sharing it to them via either QR code or a copied URL and they will be prompted to their mobile app store to download the mobile client and create an account.
