...
- **Galaxies**: 2^8 one syllable names, like `~zod`  
- **Stars**: 2^16 two syllable names, like `~sarlev` 
- **Planets**: 2^32 four syllable names, like `~sampel-palnet`
- **Moons**: 2^64 eight syllable names, like `~mister-dister-dozzod-dozzod`
- **Comets**: 2^128 sixteen syllable names, generally rendered in a truncated manner, like `~hassun-hassel-pinrec-dilleg--sitmes-tolrus-lidmeg-marzod`
